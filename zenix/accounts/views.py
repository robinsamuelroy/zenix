...
from accounts.backends import EmailBackend  # Import your custom authentication backend
import random
    ...
    if request.method == 'POST':
        ...
        try:
          ...
          if user is not None:
              ...
              return redirect("shop:index")  # Redirect to the desired page after successful login
          else:
    ...
    if request.method == 'POST':
        ...
        #   user = authenticate(email=email)
          ...
          if user is not None:
            ...
            return render(request,'accounts/otp_login.html',{"email":email})
        #   
        except:
          messages.warning(request, f'User with {email} doesnot exists')
    ...
    if request.method == 'POST':
        ...
        try:
            if otp_ == request.session["otp"]:
                ...
                redirect_url = reverse('shop:index')
